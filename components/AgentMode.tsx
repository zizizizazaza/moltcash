      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-10">
          <div className="glass p-12 rounded-[40px] bg-white border border-gray-100 h-full flex flex-col justify-between">
            <div>
              <div className="inline-block px-3 py-1 bg-gray-50 rounded-full text-[10px] font-bold text-gray-500 tracking-widest uppercase mb-6 border border-gray-100">x402 Protocol</div>
        ...
        <div className="space-y-6 flex flex-col">
          <div className="flex-1 glass p-10 rounded-[40px] bg-white border border-gray-100">
            <h3 className="text-[10px] font-bold tracking-[0.2em] text-gray-400 mb-8 uppercase flex items-center gap-3">
            ...
            {apiKey ? (
               <div className="space-y-8 animate-fadeIn">
                 <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 font-mono text-xs">
                    <p className="text-gray-400 mb-2 uppercase text-[9px]">Provisioned Access Key</p>
                    <p className="text-black break-all">{apiKey}</p>
                 </div>
                 
                 <div className="space-y-4">
                    <p className="text-[10px] text-gray-400 font-bold tracking-widest uppercase">Implementation Snippet</p>
              ...
              <div className="h-full flex flex-col items-center justify-center text-center opacity-10 py-20">
                ...
                <p className="text-xs font-bold tracking-widest uppercase">No Active Session</p>
              </div>
            )}
          </div>
        </div>
...
const FeatureItem: React.FC<{ title: string; desc: string }> = ({ title, desc }) => (
  <div className="flex items-start gap-4">
    ...
    <div>
      <h4 className="text-black font-bold text-xs uppercase tracking-widest mb-1">{title}</h4>
