      ...
      <div className="lg:col-span-7 space-y-12">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center text-white font-black text-lg">A</div>
            <h2 className="text-2xl font-bold tracking-tight">AIUSD</h2>
          </div>
          <div className="flex flex-col md:flex-row md:items-end gap-6">
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Current APY</p>
            ...
            <div className="flex gap-4 pb-1">
              <div className="px-4 py-2 bg-gray-50 border border-gray-100 rounded-2xl">
                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-tighter">30-Day Avg</p>
                <p className="text-sm font-bold text-black">5.12%</p>
              </div>
              <div className="px-4 py-2 bg-gray-50 border border-gray-100 rounded-2xl">
                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-tighter">TVL</p>
        ...
        <section className="glass rounded-[40px] p-8 bg-white overflow-hidden relative">
          <div className="flex justify-between items-center mb-8">
            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Total Return</h4>
                    ...
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-black text-white p-3 rounded-2xl border border-white/10 text-xs shadow-xl">
                          <p className="opacity-50 text-[9px] uppercase mb-1">Total Balance</p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Underlying Assets</h4>
          ...
          <div className="h-[180px] relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              ...
              <span className="text-[9px] text-gray-400 uppercase font-bold tracking-tighter">Backed</span>
            </div>
          </div>
        </section>
        ...
        <div className="sticky top-32 glass rounded-[40px] p-8 bg-white border border-gray-100 shadow-2xl space-y-8">
          ...
          <div className="flex bg-gray-50 p-1 rounded-full border border-gray-100">
            <button 
              ...
              className={`flex-1 py-3 rounded-full text-[11px] font-bold tracking-widest uppercase transition-all ${mode === 'DEPOSIT' ? 'bg-white text-black shadow-sm' : 'text-gray-400 hover:text-black'}`}
            >
              Deposit / Buy
            </button>
            <button 
              onClick={() => setMode('REDEEM')}
              className={`flex-1 py-3 rounded-full text-[11px] font-bold tracking-widest uppercase transition-all ${mode === 'REDEEM' ? 'bg-white text-black shadow-sm' : 'text-gray-400 hover:text-black'}`}
            >
              Redeem / Sell
            </button>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-6 bg-gray-50 rounded-3xl border border-gray-100">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-2xl border border-gray-200 shadow-sm shrink-0">
                  ...
                  <span className="text-xs font-bold uppercase">{mode === 'DEPOSIT' ? 'USDC' : 'AIUSD'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-gray-50/50 rounded-3xl border border-gray-100">
              <div className="flex justify-between mb-3">
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Receive</span>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-2xl border border-gray-200 shadow-sm shrink-0">
                  ...
                  <span className="text-xs font-bold uppercase">{mode === 'DEPOSIT' ? 'AIUSD' : 'USDC'}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex justify-between text-[10px] text-gray-500 font-medium">
              ...
              <span className="text-blue-600 font-bold tracking-tight bg-blue-50 px-2 py-0.5 rounded-md uppercase">Platform Covered</span>
            </div>
          ...
          <button 
            ...
            className="w-full py-5 bg-black text-white rounded-full font-bold uppercase text-[11px] tracking-[0.3em] hover:bg-gray-800 transition-all shadow-xl"
          >
          ...
          <div className="flex justify-center gap-6 pt-4 grayscale opacity-40">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[9px] font-bold uppercase tracking-tighter">Audited Contracts</span>
            </div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[9px] font-bold uppercase tracking-tighter">US Treasury Backed</span>
            </div>
          </div>
        </div>
      </div>
